...
resource "azurerm_network_security_rule" "kube_apiserver" {
  ...
  source_address_prefix       = # Removed for security # Replace with your public IP address
...
resource "azurerm_network_security_rule" "ssh" {
  ...
  source_address_prefix       = #Removed for security  # Replace with your public IP or IP range
  destination_address_prefix  = "*"
  resource_group_name         = azurerm_resource_group.networking.name
  network_security_group_name = azurerm_network_security_group.aks_nsg.name
}
